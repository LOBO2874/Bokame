...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://atri.dpdns.org/", // 请替换为你的站点URL，以斜杠结尾
	...
	bilibili: {
		vmid: "3546634965224307", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				...
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/3546634965224307",
					external: true,
...
export const commentConfig: CommentConfig = {
	...
	giscus: {
		repo: "LOBO2874/Bokame",
		repoId: "1233339464",
		category: "Announcements",
		categoryId: "DIC_kwDOSYNESM4C9v3F",
		mapping: "pathname",
		strict: "0",
		reactionsEnabled: "1",
		emitMetadata: "0",
...
export const announcementConfig: AnnouncementConfig = {
	title: "欢迎", // 公告标题，填空使用i18n字符串Key.announcement
